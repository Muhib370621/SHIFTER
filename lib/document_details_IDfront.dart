...
//
// class DocDetailsIDFront extends StatefulWidget {
//   final User user;
//   DocDetailsIDFront({required this.user});core
//   @override
//   _DocDetailsIDFrontState createState() => _DocDetailsIDFrontState();
// }
//
// class _DocDetailsIDFrontState extends State<DocDetailsIDFront> {
//  late File file;
//   String fileName = '';
//   String loc="";
...
// <soap:Body>
//   <DriverIdentityFront xmlns="http://Mgra.WS/">
//     <ID>${widget.user.id}</ID>
//     <IdntityFront>$base64Image</IdntityFront>
//   </DriverIdentityFront>
// </soap:Body>
// </soap:Envelope>''';
...
//               headers: {
//                 "SOAPAction": "http://Mgra.WS/DriverIdentityFront",
...
//           .getElementsByTagName('DriverIdentityFrontResult')[0]
//           .text;
...
//                         : 'الهوية الوطنية (الواجهة الأمامية)',
...
//                   ),
//                   Text(loc == 'en'
//                       ? '1-Place the front-end ID photo'
//                       : '1-قم بوضع صورة الواجهة الأمامية للهوية'),
//                   SizedBox(
//                     height: 5,
//                   ),
//                   Text(loc == 'en'
