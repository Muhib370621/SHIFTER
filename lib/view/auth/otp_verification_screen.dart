...
import 'package:shifter/controller/otp_verification_controller.dart';
                   ...
                   children: [
                     ...
                     OTPTextField(
                       ...
                       onCompleted: (pin) {
                         // G.debubLog(pin);
                         if (pin.length == 6) {
                           otpVerificationController.otpCode.value = pin;
                     ...
                     Obx(() {
                       return CustomButton(
                         ...
                         onTap: () {
                           otpVerificationController.verifyDriverOtp();
