...
import 'package:shifter/account_icons.dart';
import 'package:shifter/help_icons.dart';
import 'package:shifter/user.dart';
import 'help_two.dart';
...
class HelpOne extends StatefulWidget {
  ...
  HelpOne({required this.user, required this.orderid});
  @override
  _HelpOneState createState() => _HelpOneState();
}
  final _scaffoldKey = GlobalKey<ScaffoldState>();

class _HelpOneState extends State<HelpOne> {
  String loc="";
...
class HelpWidget extends StatefulWidget {
  ...
  HelpWidget({this.action="", this.id ="", this.sub ="", this.title ="", required this.user, this.orderid =""});
  @override
